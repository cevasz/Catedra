...
final Uri kUpdateManifestUrl =
    Uri.parse('https://github.com/cevasz/Catedra/releases/latest/download/version.json');
final Uri kDevManifestUrl =
    Uri.parse('https://github.com/cevasz/Catedra/releases/download/dev/version.json');
...
class UpdateChannel {
  ...
  static const _channel = MethodChannel('catedra/updates');
  ...
  /// Android pide permiso para instalar apps desde Cátedra.
