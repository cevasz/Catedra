...
/// para pasar los datos entre «Cátedra» y «Cátedra Dev», a otro teléfono o
...
abstract final class Backup {
  ...
  static const String extension = 'catedra';
  ...
  /// Nombre del archivo exportado: `catedra-2026-09-24.catedra`.
  static String fileName(DateTime now, {String prefix = 'catedra'}) {
