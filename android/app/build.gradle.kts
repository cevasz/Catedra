...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.catedra.catedra"
    ...
    //   prod  «Cátedra»      la estable: la que se comparte y se publica en
    //                        GitHub, firmada con la clave de release.
    //   dev   «Cátedra Dev»  la de trabajo: otro id, otro nombre, ícono en
    ...
    productFlavors {
        create("prod") {
            dimension = "canal"
            resValue("string", "app_name", "Cátedra")
        ...
        create("dev") {
            ...
            resValue("string", "app_name", "Cátedra Dev")
