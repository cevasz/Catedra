...
class NextClassWidgetProvider : HomeWidgetProvider() {
    ...
    private fun bind(context: Context, prefs: SharedPreferences, v: RemoteViews, data: WidgetData?, size: Size) {
        val next = data?.next()
        val border = ContextCompat.getColor(context, R.color.catedra_surface_border)
        val primary = ContextCompat.getColor(context, R.color.catedra_text_primary)
        val tertiary = ContextCompat.getColor(context, R.color.catedra_text_tertiary)
        val urgentColor = ContextCompat.getColor(context, R.color.catedra_accent_urgent)
