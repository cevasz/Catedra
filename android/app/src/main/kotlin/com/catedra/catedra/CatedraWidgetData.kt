...
class WidgetData(
    ...
    companion object {
        const val KEY = "catedra_upcoming"
        ...
        private val subjectColors = intArrayOf(
            R.color.catedra_subject_0, R.color.catedra_subject_1, R.color.catedra_subject_2,
            R.color.catedra_subject_3, R.color.catedra_subject_4, R.color.catedra_subject_5,
