 ...
 * notificaciones de Cátedra, programadas con AlarmManager.
 *
...
object EvalReminders {
    private const val PREFS = "catedra_reminders"
    private const val IDS = "ids"
    const val CHANNEL = "catedra_evaluations"
...
class EvalReminderReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notification = NotificationCompat.Builder(context, EvalReminders.CHANNEL)
            .setSmallIcon(R.drawable.ic_stat_catedra)
