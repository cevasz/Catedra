...
import 'package:catedra/core/db/daos/subjects_dao.dart';
import 'package:catedra/core/db/database.dart';
import 'package:catedra/core/providers.dart';
import 'package:catedra/features/import/application/import_controller.dart';
import 'package:catedra/features/import/data/column_schedule_parser.dart';
import 'package:catedra/features/import/data/pdf_text.dart';
...
void main() {
  late CatedraDatabase db;
  late ProviderContainer container;

  setUp(() {
    db = CatedraDatabase.forTesting(NativeDatabase.memory());
